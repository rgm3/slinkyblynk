...
// Trivially modified by rgm for Particle Libraries 2 offline compile
// capability.  It looks like perhaps the DS1820B library would be
// better to use than this one.
